                                ...
                                <div class="row row-cols-1 row-cols-md-4  g-4">
                                    <div class="col">
                                        <div class="card h-100 bg-dark text-white" >
                                            ...
                                            <div class="card-body" onclick="window.location='singleProductView.php'">
                                            ...
                                            <div class="card-footer border-secondary">
                                                <button class="btn btn-outline-warning col-12 mb-3" onclick="window.location='cart.php'">Add to Cart</button>
                                                <button class="btn btn-outline-success col-12 mb-3" onclick="window.location='singleProductView.php'">By Now</button>
                                                <button class="btn btn-outline-danger col-12 " onclick="window.location='watchlist.php'">Add to Watchlist</button>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col">
